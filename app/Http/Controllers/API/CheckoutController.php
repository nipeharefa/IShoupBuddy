...
class CheckoutController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json($carts, 200, [], 128);
    ...
    public function calculateEstimates($start_lat, $start_lng, $stop_lat, $stop_lng)
    {
        $data = [
    ...
    public function indexCartResponse(Vendor $vendor, Cart $cart, array $shipment)
    {
